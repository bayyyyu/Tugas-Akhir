...
<head>
    ...
    {{-- <link rel="stylesheet" href="{{ url('/') }}/assets-sig/assets/css/bootstrap.min.css" /> --}}
    ...
    <div class="pcoded-main-container">
        <div class="pcoded-wrapper">
            <div class="pcoded-content">
                <div class="row ml-1 mr-1 no-gutters">
                    <div class="col-md-8 maps">
                        <div class="card  mt-2">
                            <div class="card-header">
                                Peta
                            </div>
                            <div id="map" style="height: 73vh; width:100%;  margin-left:auto; margin-right:auto"
                                ...
                                <ul class="nav nav-tabs" style=" border-bottom: none;">
                                    ...
                                    {{-- <li class="nav-item">
                                        <a class="nav-link" id="detail-tab" data-toggle="tab" href="#detail"
                                            style="height:39px">Detail</a>
                                    </li> --}}
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="tab-content">
                                    <div id="tools" class="tab-pane fade show active" style="height: 67vh">
