<x-web.app-webNoSlider>
    <section class="shop-single" style="margin-top:12vh">
        <div class="container">
            <div class="judul-atas">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="background-color:#F6FFF7">
                        <li class="breadcrumb-item"><a href="{{ url('Home') }}">Beranda</a></li>
                        <li class="breadcrumb-item" style="color:black">Projek</li>
                        <li class="breadcrumb-item active" aria-current="page" style="color:#045F50">Event</li>
                    </ol>
                </nav>
            </div>
