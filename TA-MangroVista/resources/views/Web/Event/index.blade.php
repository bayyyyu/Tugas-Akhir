                                ...
                                <div class="post-inner">
                                    <div class="post-content ">
                                        ...
                                        <div class="search-container">
                                            <input class="search" style="border:2px solid #064635; border-radius:5px"
                                                type="text" id="searchInput" placeholder=" Cari event..."
                                                onkeydown="handleSearch(event)">
                                            <button class="btn btn-sm mr-1" id="clearSearch"
                                                style="display: none; cursor: pointer; border-radius:50px; background-color:white; border:2px solid #064635; font-weight:bolder; color:#064635"
                                                onclick="clearSearch()"><i class="icofont-close"></i></button>
                                            <button class="btn btn-sm" onclick="searchEvent()"
                                                style="border-radius:50px; background-color:white; border:2px solid #064635; font-weight:bolder; color:#064635"><i
