...
<head>
    <meta charset="UTF-8">
    <title>CodePen - Pure CSS Responsive animated info card</title>
...
<body>
    <!-- partial:index.partial.html -->
      ...
      <div class="tab-content-item" id="peran-content" >
    <div class="wraps animate pop">
        <div class="overlays">
            <div class="overlay-contents animate slide-left delay-2">
            ...
            <div class="image-contents animate slide delay-5"></div>
        ...
        <div class="text">
            <p>Trees are woody perennial plants that are a member of the kingdom <em>Plantae</em>. All species of trees
                are grouped by their genus, family, and order. This helps make identifying and studying trees easier.
            </p>
