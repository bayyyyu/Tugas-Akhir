<div class="topbar">
    ...
    <nav class="navbar-custom">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-lg pt-0">
                    ...
                    <div class="notification-menu" data-simplebar>
                        ...
                        <a href="#" class="dropdown-item py-3">
                            ...
                            <div class="media">
                                <div class="avatar-md bg-soft-primary">
                                    <img src="{{ url('/') }}/assets-admin/assets/images/users/user-4.jpg"
                        ...
                        <a href="#" class="dropdown-item py-3">
                            ...
                            <div class="media">
                                <div class="avatar-md bg-soft-primary">
                                    <img src="{{ url('/') }}/assets-admin/assets/images/users/user-5.jpg"
                                        alt="" class="thumb-sm rounded-circle">
                                </div>
                                <div class="media-body align-self-center ms-2 text-truncate">
                                    <h6 class="my-0 fw-normal text-dark">Your order is placed</h6>
        ...
        <ul class="list-unstyled topbar-nav mb-0">
            ...
            <li class="creat-btn">
                <div class="nav-link">
                    <a class=" btn btn-sm btn-soft-primary" href="{{url('Home')}}" role="button"><i class="fa fa-arrows-alt" aria-hidden="true"></i> Halaman Pengunjung</a>
                </div>
            </li>
        </ul>
    </nav>
